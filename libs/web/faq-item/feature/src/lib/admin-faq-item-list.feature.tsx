import { CoreUiBack, CoreUiDebugModal, CoreUiPage, CoreUiSearchField } from '@islanddao-platform/web-core-ui'
import { useAdminFindManyFaqItem } from '@islanddao-platform/web-faq-item-data-access'
import { AdminFaqItemUiTable } from '@islanddao-platform/web-faq-item-ui'
