import { AdminCommunityFeature } from '@islanddao-platform/web-community-feature'
import { CoreUiDashboardGrid, CoreUiDashboardItem, CoreUiNotFound } from '@islanddao-platform/web-core-ui'
import { DevAdminRoutes } from '@islanddao-platform/web-dev-feature'
import { AdminDiscordFeature } from '@islanddao-platform/web-discord-feature'
import { AdminFaqItemFeature } from '@islanddao-platform/web-faq-item-feature'
import { AdminProjectFeature } from '@islanddao-platform/web-project-feature'
import { AdminRatingFeature } from '@islanddao-platform/web-rating-feature'
import { AdminUserFeature } from '@islanddao-platform/web-user-feature'
